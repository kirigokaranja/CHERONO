    ...
    <div id="box_wrapper" class="">
        ...
        <div id="wowslider-container1">
            <div class="ws_images"><ul>
                    <li><a href="http://wowslider.com/vi"><img src="data1/images/slide3.jpg" alt="cssslider" title="" id="wows1_0"/></a></li>
                    <li><img src="data1/images/slide4.jpg" alt="" title="" id="wows1_1"/></li>
                </ul></div>
            <div class="ws_bullets"><div>
                    <a href="#" title=""><span><img src="data1/tooltips/slide3.jpg" alt=""/>1</span></a>
                    <a href="#" title=""><span><img src="data1/tooltips/slide4.jpg" alt=""/>2</span></a>
                </div></div>
        ...
        <div class="fw-page-builder-content">
            <section class="fw-main-row  ls ms section_padding_top_40 section_padding_bottom_40 columns_padding_15"  id="about">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-xs-12 to_animate text-left" id="about_me" data-animation="fadeInUp" style="margin-top: 1%">
                            <div class="side-item content-padding big-padding with_background with_shadow backgrounded-media bordered-media">
                                <div class="row vertical-center-md">
                                    ...
                                    <div
                                            class="col-lg-7 col-md-7 col-md-push-1 col-sm-12 col-xs-12">
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12 col-sm-push-3 col-md-push-0 to_animate" data-animation="fadeInUp">
                            <ul class="price-table with_background with_shadow">
                                ...
                                <li class="call-to-action">
                                    ...
                                    <div class="theme_bg">
                                        <div class="vertical-item hover-content bg_teaser with_border">
                                            <img src="//webdesign-finder.com/makeup/wp-content/uploads/2017/08/still-life_1.png" alt="">
                                            <div class="item-content">
                                                <p class="plan-price highlight3">
                                                    <span>$</span>
                                                    <span>300</span>
                                                </p>
                                                <div class="content-body">
                                    ...
                                    <div class="bg_overlay color_bg_3"></div>

                                    <div class="media_cover">
                                        <img src="//webdesign-finder.com/makeup/wp-content/uploads/2017/08/texture_3.png" alt="">
                                    </div>
